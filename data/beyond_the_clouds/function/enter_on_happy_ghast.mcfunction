...
execute in minecraft:overworld as @e[tag=btc.happy_ghast_transfer_rider] in beyond_the_clouds:beyond_the_clouds at @e[type=minecraft:happy_ghast,tag=btc.happy_ghast_transfer_vehicle,limit=1] run tp @s ~ ~1 ~
execute in beyond_the_clouds:beyond_the_clouds as @e[tag=btc.happy_ghast_transfer_rider] at @s run ride @s mount @e[type=minecraft:happy_ghast,tag=btc.happy_ghast_transfer_vehicle,limit=1,sort=nearest]
...
execute in beyond_the_clouds:beyond_the_clouds run tag @e[tag=btc.happy_ghast_transfer_rider] remove btc.happy_ghast_transfer_rider
