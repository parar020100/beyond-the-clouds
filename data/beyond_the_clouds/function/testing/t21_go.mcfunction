say [t21] Поднимаю лодку выше порога. Живого способа поднять лодку нет, поэтому телепорт.
...
execute in minecraft:overworld as @e[tag=btc.test.lift] run tp @s 1000 520 1000
