...
execute if entity @s[type=minecraft:player] if items entity @s armor.chest minecraft:elytra run return run function beyond_the_clouds:leave/alone_no_effects
